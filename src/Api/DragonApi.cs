...
public static class DragonApi {
    ...
    public static async Task<string> CreateDragonFromXML(HttpClient client, string childApiToken, string userID, XmlNode raisedPetData, string? imageData) {
        ...
        await ImageApi.SetImage(client, childApiToken, newPetXml.RaisedPetData.ImagePosition.Value, imageData);
